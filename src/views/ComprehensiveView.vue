    ...
    <div class="info-display-container">
      ...
      <div class="recommend-params-container">
        <div class="params-row">
          <span style="margin-right: 10px;">参数</span>
      ...
      <div v-if="progress === 100">
        <div class="recommend-result-box">
          <div>拟推荐情报8，情报9，匹配准确率：96%，<br />
            推荐情报4理由：用户曾经xx时刻点击情报3，情报3与情报4的属性1具有0.6的相似程度<br />
            推荐情报5理由：用户曾经xx时刻点击情报3，情报3与情报5的属性1具有0.5的相似程度</div>
        </div>
  ...
  const option = {
    ...
    series: [{
      ...
      data: [
        ...
        { name: '情报4', x: 300, y: 200, label: { show: true } },
        { name: '情报5', x: 400, y: 200, label: { show: true } },

        { name: '台湾', x: 0, y: 150, label: { show: true }, symbol: 'rect' },
        { name: '战斗机', x: 0, y: 250, label: { show: true }, symbol: 'rect' },
        { name: '南海', x: 100, y: 150, label: { show: true }, symbol: 'rect' },
        { name: '战斗机2', x: 100, y: 250, label: { show: true }, symbol: 'rect' },
        { name: '罗斯福', x: 200, y: 150, label: { show: true }, symbol: 'rect' },
        { name: '战斗机3', x: 200, y: 250, label: { show: true }, symbol: 'rect' },
        { name: '梅根号', x: 300, y: 150, label: { show: true }, symbol: 'rect' },
        { name: '战斗机4', x: 300, y: 250, label: { show: true }, symbol: 'rect' },
        { name: '航母', x: 400, y: 100, label: { show: true }, symbol: 'rect' },
        { name: '战斗机5', x: 400, y: 250, label: { show: true }, symbol: 'rect' },
      ],
      links: [
        { source: '情报1', target: '台湾', lineStyle: { type: 'dashed' } },
        { source: '情报1', target: '战斗机', lineStyle: { type: 'dashed' } },
        { source: '情报1', target: '情报2' },
        { source: '情报2', target: '情报3' },
        { source: '情报3', target: '情报4', lineStyle: { type: 'dashed', color: 'red' }, label: { show: true, formatter: '匹配度0.6', color: 'red' } },
        { source: '情报4', target: '情报5', lineStyle: { type: 'dashed', color: 'red' }, label: { show: true, formatter: '匹配度0.8', color: 'red' } },
        { source: '情报2', target: '南海', lineStyle: { type: 'dashed' } },
        { source: '情报2', target: '战斗机2', lineStyle: { type: 'dashed' } },
        { source: '情报3', target: '罗斯福', lineStyle: { type: 'dashed' } },
        { source: '情报3', target: '战斗机3', lineStyle: { type: 'dashed' } },
        { source: '情报4', target: '梅根号', lineStyle: { type: 'dashed' } },
        { source: '情报4', target: '战斗机4', lineStyle: { type: 'dashed' } },
        { source: '情报5', target: '航母', lineStyle: { type: 'dashed' } },
        { source: '情报5', target: '战斗机5', lineStyle: { type: 'dashed' } },
        { source: '罗斯福', target: '梅根号', lineStyle: { width: 4, color: 'red' }, curveness: -0.4 },
        { source: '罗斯福', target: '航母', lineStyle: { width: 4, color: 'red' }, curveness: 0.4 },
        { source: '战斗机3', target: '战斗机4', lineStyle: { width: 4, color: 'red' } },
